...
<a href="{{ $url }}" class="next-lesson flex flex-col sm:flex-row items-center">
    <div class="flex-none relative w-full h-auto sm:w-68 sm:max-h-40 rounded-lg overflow-hidden">
        <img src="{{ $thumbnail }}" class="object-cover object-center w-auto sm:h-auto">
    ...
    <div class="flex-1 flex flex-row pt-4 sm:pt-0 sm:pl-6 items-center">
        ...
        <div class="hidden sm:flex flex-row items-center justify-end w-2/5 text-medium-gray text-xs">
