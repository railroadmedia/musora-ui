...
<div class="p-8 border-b border-gray">
    ...
    @component(
        'musora-ui::utilities.modal-form',
        [
        ...
        <div class="flex flex-col space-y-4 sm:space-y-0 sm:flex-row sm:space-x-3">
            <div class="flex-1">
                @component('musora-ui::utilities.select-input', [
                    'labelText' => 'Country',
                    'inputName' => 'country',
            ...
            <div class="flex-1">
                @component('musora-ui::utilities.flatpickr-input', [
                    'labelText' => 'Birthday',
                    'inputName' => 'birthday',
        ...
        <div>
            @component('musora-ui::utilities.textarea-input', [
                'labelText' => 'Biography',
                'inputName' => 'biography',
